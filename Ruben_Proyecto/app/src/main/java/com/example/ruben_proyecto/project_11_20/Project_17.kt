...
@Composable
fun Project_17(navController: NavController) {
    ...
    Column(
                ...
                Button(
                    onClick = {
                        ...
                        if (number >= 1 && number < 10) {
                            numberDigit = numberStr.length
                        } else if (number <= 99) {
                            numberDigit = numberStr.length
                        }

                        result = "The number $number have ${numberDigit.toString()} digit/s"
                    },
                    modifier = Modifier
                        .width(200.dp)
                        .height(40.dp)
        ...
        Column(
            ...
            Footer(navController, numberProject = 17)
        }
