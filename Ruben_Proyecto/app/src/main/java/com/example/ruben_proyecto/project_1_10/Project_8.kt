...
@Composable
fun Project_8(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            Row() {
                Row() {
                    Text(
                        text = "Multiplication of number 3 and 4: "
                    )
                }
                Row(
                    modifier = Modifier.weight(1f)
