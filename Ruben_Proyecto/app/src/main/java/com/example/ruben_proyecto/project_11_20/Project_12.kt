...
@Composable
fun Project_12(navController: NavController) {
    ...
    Column(
                ...
                Button(
                    onClick = {
                        ...
                        if (num1 < num2) {
                            ...
                            val sub = num1 - num2
                            result =
                                "The sum is: ${sum.toString()} \nThe substraction is: ${sub.toString()} "
                        } else {
                            val mult = num1 * num2
                            val div = num1 / num2
                            result =
                                "The multiplication is: ${mult.toString()} \nThe division is: ${div.toString()} "
                        }
        ...
        Column(
            ...
            Footer(navController, numberProject = 12 )
        }
