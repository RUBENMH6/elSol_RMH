...
@Composable
fun Project_15(navController: NavController) {
    ...
    Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        result = "The largest of $num1 and $num2 is $largestNum"
                    },
                    modifier = Modifier
                        .width(200.dp)
                        .height(40.dp)
        ...
        Column(
            ...
            Footer(navController, numberProject = 15 )
        }
    }
