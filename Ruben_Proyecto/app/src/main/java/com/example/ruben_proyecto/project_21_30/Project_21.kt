...
@Composable
fun Project_21(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Enter the number between 1-999") }
            )
                ...
                Button(
                    onClick = {
                        ...
                        if (number >= 1 && number < 10) {
                            result = "A number have 1 digit"
                        } else {
                            if (number <= 99) {
                                result = "A number have 2 digit"
                            } else if (number <= 999) {
                                result = "A number have 3 digit"
                            }
                        }
                    },
                    modifier = Modifier
        ...
        Column(
            ...
            Footer(navController, numberProject = 21 )
        }
