...
@Composable
fun Project_39(navController: NavController) {
    ...
    Column(
                    ...
                    Button(
                        onClick = {
                            ...
                            while (sumatory < 500) {
                                ...
                                if (sumatory < 500) {
                                    if (x % 5 == 0) {
                                        result += sumatory.toString() + "\n"
                                    } else {
                                        var lastCheck = sumatory + 8
                                        if ( lastCheck > 500  ) {
                                            result += sumatory.toString() + "\n"
                                        } else {
                                            result += sumatory.toString() + " - "
        ...
        Column(
            ...
            Footer(navController, numberProject = 39 )
        }
