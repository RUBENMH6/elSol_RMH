...
@Composable
fun Project_14(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Enter the number between 1-99") }
            )
            ...
            Row(
                ...
                Button(
                    onClick = {
                        val numberDigit = numberStr.length
                        if (numberDigit == 1) {
                            result = "The number $numberStr have $numberDigit digit"
                        } else {
                            if (numberStr.length > 2) {
                                result = "Please. Enter the number between 1-99"
                            } else {
                                result = "The number $numberStr have $numberDigit digits"
                            }
        ...
        Column(
            ...
            Footer(navController, numberProject = 14 )
        }
