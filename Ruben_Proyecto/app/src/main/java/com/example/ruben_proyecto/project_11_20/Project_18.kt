...
@Composable
fun Project_18(navController: NavController) {
    var grade1Str by remember { mutableStateOf("") }
    var grade2Str by remember { mutableStateOf("") }
    var grade3Str by remember { mutableStateOf("") }
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { newValue -> grade1Str = newValue },
                label = { Text("Insert a grade") }
            )
            Spacer(modifier = Modifier.size(100.dp, 10.dp))
            OutlinedTextField(
                value = grade2Str,
                modifier = Modifier.fillMaxWidth(),
                onValueChange = { newValue -> grade2Str = newValue },
                label = { Text("Insert a grade") }
            )
            Spacer(modifier = Modifier.size(100.dp, 10.dp))
            OutlinedTextField(
                value = grade3Str,
                modifier = Modifier.fillMaxWidth(),
                onValueChange = { newValue -> grade3Str = newValue },
                label = { Text("Insert a grade") }
            )
        ...
        Column(
            ...
            Footer(navController, numberProject = 18 )
        }
