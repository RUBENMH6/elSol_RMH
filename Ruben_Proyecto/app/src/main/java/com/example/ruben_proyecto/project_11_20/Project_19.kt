...
@Composable
fun Project_19(navController: NavController) {
    var number1Str by remember { mutableStateOf("") }
    var number2Str by remember { mutableStateOf("") }
    var number3Str by remember { mutableStateOf("") }
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Insert a first number") }
            )
            ...
            OutlinedTextField(
                ...
                label = { Text("Insert a second number") }
            )
            Spacer(modifier = Modifier.size(100.dp, 10.dp))
            OutlinedTextField(
                value = number3Str,
                ...
                label = { Text("Insert a third number") }
            )
            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        val number3 = number3Str.toInt()

                        if (number1 > number2) {
                            if (number1 > number3) {
                                result = "Largest: $number1"
                            } else {
                                result = "Largest: $number3"
                            }
                        } else {
                            if (number2 > number3) {
                                result = "Largest: $number2"
                            } else
                                result = "Largest: $number3"
                        }
        ...
        Column(
            ...
            Footer(navController, numberProject = 19 )
        }
