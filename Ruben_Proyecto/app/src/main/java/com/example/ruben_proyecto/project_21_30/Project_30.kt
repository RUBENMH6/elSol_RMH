...
@Composable
fun Project_30(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = {
                        var max = number1Str.toInt()
                        var min = number1Str.toInt()

                        if (number2Str.toInt() > max) {
                            max = number2Str.toInt()
                        } else if (number2Str.toInt() < min) {
                            min = number2Str.toInt()
                        }

                        if (number3Str.toInt() > max) {
                            max = number3Str.toInt()
                        } else if (number3Str.toInt() < min) {
                            min = number3Str.toInt()
                        }
        ...
        Column(
            ...
            Footer(navController, numberProject = 30 )
        }
